      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="backdrop-blur-lg bg-white/10 border-4 border-blue-900 rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 shadow-lg">
          ...
          <div className="text-white/90 space-y-4 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed font-sans">
            <p>
              <strong>
                1. All <span className="text-yellow-300">team members</span> should be from the same college; 
                <span className="text-yellow-300"> no inter-college </span>teams are allowed. However, members from 
                <span className="text-yellow-300"> different branches </span> of the same college/institute are encouraged to form a team.
              </strong>
            </p>

            <p>
              <strong>
                2. Each team would comprise <span className="text-yellow-300">2–4</span> members, 
            ...
            <p>
              <strong>
                3. As the <span className="text-yellow-300">software edition</span> of the hackathon 
                is a digital product development competition, the majority of the team members must 
                be well versed with <span className="text-yellow-300">programming skills</span>. For the 
                <span className="text-yellow-300"> hardware edition, </span> we encourage multidisciplinary teams – 
            ...
            <p className="pt-2">
              <strong>
                Please Note: NIT Raipur will be providing <span className="text-yellow-300">meals, travel</span> and 
                <span className="text-yellow-300"> accommodation free of cost.</span> Travel charges up to 
                <span className="text-yellow-300"> Rs. 1500 </span> per person to and fro will be reimbursed when 
