...
import FWClickOnly from "../overlays/FW(ClickOnly)";
import "./spons.css";
...
const Spons = () => {
    ...
    return (
        <>
            <section ref={containerRef} className={`static h-[180vh]`}>
                ...
                <div
                    className={`${isFixed ? "fixed -top-0.1 w-full" : "static"
                        } top-0 h-screen flex flex-col items-center justify-center bg-transparent`}
                >
                    <h1 className="font-arcade text-5xl text-white mb-25 text-center max-md:mt-60">
                        Our Sponsors
                    </h1>

                    {/* Responsive grid on small screens, flex row on desktop */}
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 md:flex md:gap-10 h-auto items-center px-6 mt-10">
