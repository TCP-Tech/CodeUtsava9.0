...
export default function FixedScrollSplit() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-black">
      ...
      <animated.div
        className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-40 flex flex-col items-center space-y-6"
        style={textSpring}
      >
  ...
  style={{ opacity: curtainLocked.current ? 0 : 1, WebkitTextStroke: '1px black', position: 'relative', top: '-50px', left: '20px' }}
>
