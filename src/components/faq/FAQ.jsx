...
import FAQimg from "../../assets/images/faq_img_final.png"; // <-- Note: Path might need adjustment
...
export default function FAQ() {
    ...
    const faqs = [
        ...
        { q: "HOW WILL THE TEAMS BE JUDGED?", a: (<> Teams will be judged on viability, technical complexity, presentation skills, guidelines, and most importantly, creativity.{" "} <a href="./Judgement Criteria.pdf" className="text-orange-700 underline" download="Judgement Criteria" > Judgment Criteria </a> </>) },
        { q: "WHAT IS THE CODE OF CONDUCT?", a: "To ensure a positive experience for all participants, we follow the SIH Code of Conduct. Please review it before the event." },
    ];

    return (
        // This is the main container for the FAQ section
        <div id="faqs" className="flex justify-center py-12 px-4">
            <div className="max-w-6xl w-full bg-gradient-to-r from-red-500/60 via-orange-400/60 to-yellow-400/60 backdrop-blur-md rounded-2xl p-6 md:p-10 shadow-2xl">
                <h1 className="text-5xl md:text-6xl font-rye text-white drop-shadow-lg text-center mb-12 font-bold">
                    FAQs
                </h1>
