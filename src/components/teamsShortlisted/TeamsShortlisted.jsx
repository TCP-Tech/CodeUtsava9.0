        ...
        >
          ...
          <div className="relative z-[1] w-full h-full flex flex-col items-center justify-center px-4 sm:px-6 md:px-10 py-10 overflow-y-auto">
            ...
            <div className="text-center mb-6 bg-[#971b869c] text-[#ffffff] px-4 sm:px-8 py-2 sm:py-4 rounded-2xl shadow-md">
              ...
              <p className="mt-2 text-base sm:text-lg font-semibold">{team.college}</p>
            </div>
                ...
                <table className="w-full text-center border-collapse text-white">
                  <thead>
                    <tr className="bg-[#43093bb5] text-[#ffffff]">
                      <th className="border border-fuchsia-700 px-2 sm:px-4 py-2 text-sm sm:text-base">Team Member</th>
                      <th className="border border-fuchsia-700 px-2 sm:px-4 py-2 text-sm sm:text-base">Name</th>
                    </tr>
                  </thead>
                  <tbody>
                    {team.members.map((member, idx) => (
                      ...
                      >
                        ...
                        <td className="border border-fuchsia-700 px-2 sm:px-4 py-2 text-sm sm:text-base">{member}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
