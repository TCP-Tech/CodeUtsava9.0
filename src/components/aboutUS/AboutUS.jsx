        ...
        <section id="about" className="relative overflow-hidden py-16 md:py-28">
            ...
            <div className="relative z-0 max-w-7xl mx-auto px-4">
                <header className="text-center">
                    <h2 className="about-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-rye text-[#F3A83A] tracking-wide uppercase drop-shadow-[0_0_14px_rgba(251,146,60,0.95)]  ">
                        About&nbsp;Us
                    </h2>
