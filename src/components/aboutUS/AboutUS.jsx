        ...
        <section id="about" className="relative overflow-hidden">
            ...
            <div className="relative z-0 max-w-7xl mx-auto px-4">
                <header className="text-center">
                    <h2 className="about-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-rye text-[#F3A83A] tracking-wide uppercase drop-shadow-[0_0_14px_rgba(251,146,60,0.95)]  text-balance">
                        About&nbsp;Us
                    </h2>
                    {/* <div className="mx-auto mt-3 neon-hr" /> */}
                </header>

                <div className="mt-8 md:mt-12 grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-stretch h-full">
                    {/* Left: Image instead of 3D viewer */}
                    <div className="about-card p-[1px] rounded-2xl shadow-[0_10px_28px_rgba(0,0,0,0.45)] h-full">
                        <div className="about-card__inner rounded-[inherit] ring-1 ring-white/10 overflow-hidden flex items-center justify-center bg-black/40 h-full">
                            <img
                                src={culogo}
                                alt="Carnival Logo"
                    ...
                    {/* Right: copy */}
                    <div className="space-y-4 md:space-y-6 max-w-[65ch] mx-auto h-full flex flex-col justify-center">
                        <article className="glass-card p-4 sm:p-6 md:p-7 h-full flex flex-col justify-center">
