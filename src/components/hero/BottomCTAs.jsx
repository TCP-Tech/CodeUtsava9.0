  ...
  loadDevfolio();
    ...
    return (
        ...
        >
            ...
            {/* Discord and Steps buttons container */}
            <div className="flex flex-row gap-4 w-full md:w-auto">
                ...
                <a
                    ...
                    className="bg-black/60 border text-[color:var(--color-muted)] px-3 py-3 rounded-xl shadow-lg transition hover:scale-[1.02] flex items-center justify-center"
                    style={{
                        borderColor:
                            "color-mix(in srgb, var(--color-accent-2) 60%, white 40%)",
                    }}
                >
                    <svg
                        fill="currentColor"
                ...
                <a
                    ...
                    className="bg-black/60 border text-[color:var(--color-muted)] px-5 py-3 rounded-xl shadow-lg transition hover:scale-[1.02] flex-1 text-center"
                    style={{
                        borderColor:
